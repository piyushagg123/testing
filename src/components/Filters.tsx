    ...
    return (
      <>
        <div className="flex flex-col gap-1 pt-3">
          <p className="font-bold text-base text-text">THEMES</p>
        ...
        <div className="flex flex-col gap-1 pt-5">
          <p className="font-bold text-base text-text">SPACES</p>
        ...
        <div className="flex flex-col gap-7 pt-5">
          <p className="font-bold text-base text-text">EXECUTION TYPE</p>
