...
// const ProjectImages : React.FC<ProjectImagesProps> = ({ subCategories, projectId }) => {
...
//     async (spaceIndex: number, imageIndex: number, e: ChangeEvent<HTMLInputElement>) => {
...
//       } catch (error) {}
//     },
//     [subCategories, projectId, sessionStorage.getItem("token")]
//   );
...
//       } catch (error) {}
//     },
//     [spaceTypes, subCategories, projectId, sessionStorage.getItem("token")]
//   );
...
//       <div>
//         {spaceTypes.map((spaceType, spaceIndex: number) => (
//           <div
//             key={spaceIndex}
...
//               {spaceType.previews.map((preview, imageIndex: number) => (
//                 <div
//                   key={imageIndex}
